  ...
  try {
    ...
    conn.ev.on('messages.upsert', async (chatUpdate) => {
      for (const mek of chatUpdate.messages) {
        ...
        const body = (type === 'conversation') ? mek.message.conversation : (type === 'extendedTextMessage') ? mek.message.extendedTextMessage.text : (type == 'imageMessage') && mek.message.imageMessage ? mek.message.imageMessage.caption : '';
